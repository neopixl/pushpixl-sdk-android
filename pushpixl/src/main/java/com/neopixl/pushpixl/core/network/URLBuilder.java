...
public class URLBuilder {
	...
	private static String getBaseUrl(Context context,String tenant) {
		...
		String baseUrl = PushPixlManifest.getApplicationServerDomain(context);
		...
		String protocolUrl = PushPixlManifest.isApplicationusingHTTPS(context) ? HTTPS_URL_PROTOCOL : HTTP_URL_PROTOCOL;
